<template>
  <div class="login-page page-wrapper d-flex flex-column flex-center">
    <div class="container">
      <div class="row d-flex flex-center">
        <div class="col-md-6 text-center pt-3 pb-5">
          <p class="h1 text--black">Welcome back</p>
          <p class="h9 text-dark mb-4 spaced-words">Please sign into your account </p>
          <el-card
            v-loading="loading"
            class="py-3 px-3">
            <el-form
            ...
            <div class="row social-signup d-flex flex-center">
              <div class="col-10 my-3">
                <el-button round> <i
                  class="fa fa-facebook-square mr-3 h8"
                  aria-hidden="true"/>Log in with Facebook</el-button>
              </div>
              <div class="col-10">
                <el-button round><i
                  class="fa fa-google-plus-square mr-3 h8"
                  aria-hidden="true"/>Log in with Google</el-button>
              </div>
            </div>
          </el-card>
        </div>
